#ifndef SOUL_DRIVERS_CODE_SOURCES_H
#define SOUL_DRIVERS_CODE_SOURCES_H
...
class compiler_code_source: public soul::common::lex_context, public soul::common::code_source{
...
public:
	...
	void set_diag_chat( soul::common::diag_chat* );
...
private:
	// Utilities
	soul::common::code_span		current_span() const;
	bool process();
