#ifndef SOUL_PARSER_GENERATOR_H
#define SOUL_PARSER_GENERATOR_H
...
public:
	...
	boost::shared_ptr<soul::common::token_t> tok;
};
...
typedef boost::function<parse_results ( soul::common::diag_chat* /*diags*/, token_iterator const& /*origin iter*/, token_iterator& /*current start iter*/ )> error_handler;
class error_catcher;

class parser{
public:
	parser();
	virtual parse_results parse( token_iterator& iter, token_iterator end, boost::shared_ptr<attribute>& attr, soul::common::diag_chat* diags ) const = 0;
...
public:
	...
	parse_results parse( token_iterator& iter, token_iterator end, boost::shared_ptr<attribute>& attr, soul::common::diag_chat* diags ) const;
