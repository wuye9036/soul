#ifndef SOUL_SYNTAX_TREE_NODE_H
#define SOUL_SYNTAX_TREE_NODE_H
...
#define SOUL_SYNTAX_NODE_ACCEPT_METHOD_DECL() void accept( syntax_tree_visitor*, ::boost::any* data )
#define SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( node_class_name ) \
...
EFLIB_USING_SHARED_PTR(soul::common, token_t);
...
struct node: public boost::enable_shared_from_this<node>{
	...
	virtual SOUL_SYNTAX_NODE_ACCEPT_METHOD_DECL() = 0;
...
#define SOUL_SYNTAX_NODE_CREATORS() \
