#ifndef SOUL_SYNTAX_TREE_UTILITY_H
#define SOUL_SYNTAX_TREE_UTILITY_H

#include <soul/include/syntax_tree/syntax_tree_fwd.h>
#include <soul/enums/builtin_types.h>
...
#define SOUL_SYNTAX_NODE_IS_A( node, node_type ) ( (node)->node_class() == BOOST_PP_CAT(node_ids::, node_type) )
