...
using soul::common::diag_template;
using soul::common::diag_item;
using soul::common::diag_chat;
using soul::common::chat_scope;
...
parse_results error_catcher::parse( token_iterator& iter, token_iterator end, boost::shared_ptr<attribute>& attr, soul::common::diag_chat* diags ) const
{
