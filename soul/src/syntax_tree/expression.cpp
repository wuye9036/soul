...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( constant_expression );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( unary_expression );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( cast_expression );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( binary_expression );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( expression_list );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( cond_expression );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( index_expression );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( call_expression );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( member_expression );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( variable_expression );
