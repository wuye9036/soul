...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( labeled_statement );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( declaration_statement );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( expression_statement );

SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( compound_statement );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( if_statement );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( while_statement );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( dowhile_statement );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( jump_statement );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( switch_statement );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( case_label );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( ident_label );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( for_statement );
