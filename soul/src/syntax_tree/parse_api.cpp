#include <soul/include/syntax_tree/parse_api.h>
	...
	)
{
	...
	shared_ptr<soul::parser::attribute> pt_prog;
	if( soul::parser::parse( pt_prog, code_text, ctxt, l, g, diags ) )
	{
...
shared_ptr<program> parse( code_source* src, shared_ptr<lex_context> ctxt, diag_chat* diags )
{
	...
	shared_ptr<soul::parser::attribute> pt_prog;
	if( soul::parser::parse( pt_prog, src, ctxt, l, g, diags ) )
	{
		syntax_tree_builder builder(l, g);
		return builder.build_prog( pt_prog );
	}
