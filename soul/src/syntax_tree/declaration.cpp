...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( expression_initializer );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( member_initializer );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( declarator );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( variable_declaration );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( type_definition );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( builtin_type );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( array_type );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( struct_type );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( parameter );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL(parameter_full);
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( function_full_def );
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL(function_def);
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL(function_type);
...
SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( null_declaration );

SOUL_SYNTAX_NODE_ACCEPT_METHOD_IMPL( alias_type );
